 ...
 * Copyright (C) 2021 The Lewa Revived OS Project
 *
...
public class LewaRevivedVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "lineageVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_LEWA_REVIVED_VERSION_PROP = "ro.lewa-revived.version";
    ...
    public LewaRevivedVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_LEWA_REVIVED_VERSION_PROP,
